...
export default async function BagRoute() {
    ...
    return (
        <div className="max-w-4xl mx-auto mt-10 min-h-[55vh]">
            {!cart || !cart.items || cart?.items.length === 0 ? (
                <div className="flex min-h-[400px] flex-col items-center 
                                justify-center rounded-lg border border-dashed p-8 text-center mt-20">
                ...
                <div className="flex flex-col gap-y-10">
                            ...
                            <div className="ml-5 flex justify-between w-full font-medium">
                                ...
                                <div className="flex flex-col h-full justify-between">
                                    <div className="flex items-center gap-x-2">
                                        <p>{item.quantity} x</p>
                                        <p>Rp {new Intl.NumberFormat("en-US").format(item.price)}.00</p>
                                    </div>
                    ...
                    <div className="mt-10">
                        <div className="flex items-center justify-between font-medium">
                            <p>Subtotal:</p>
                            <p>Rp {new Intl.NumberFormat("en-US").format(totalPrice)}.00</p>
                        </div>
