...
import { HandCoins, PartyPopper, ShoppingBag, User2 } from "lucide-react";
        ...
        <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
            <Card>
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                    ...
                    <HandCoins className="h-4 w-4 text-green-500"></HandCoins>
                </CardHeader>
                <CardContent>
                    <p className="text-2xl font-bold">Rp {new Intl.NumberFormat("en-US").format(totalAmount / 100)}</p>
                    <p className="text-xs text-muted-foreground">Based on 2024</p>
                </CardContent>
            </Card>
            <Card>
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">Total Sales on Woof and Whiskers</p>
                </CardContent>
            </Card>
            <Card>
                <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">Total of Users</p>
                </CardContent>
            </Card>
        </div>
    )
